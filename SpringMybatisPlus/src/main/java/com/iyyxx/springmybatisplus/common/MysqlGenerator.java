...
public class MysqlGenerator {
    ...
    public static final String DATABASE_URL = "jdbc:mysql://192.168.20.145:3306/mbp?characterEncoding=utf8&useSSL" +
            "=false&serverTimezone=Asia/Shanghai";
    public static final String DATABASE_DRIVER = "com.mysql.cj.jdbc.Driver";
    public static final String DATABASE_USERNAME = "root";
    public static final String DATABASE_PASSWORD = "123456";

    public static final String OUT_PUT_PATH = "/SpringMybatisPlus/src/main/java";
    public static final String TEMPLATES_MAPPER_XML_PATH = "/templates/mapper.xml.ftl";
    public static final String XML_PATH = "/SpringMybatisPlus/src/main/resources/mapper/";
    public static final String XML_POSTFIX = "Mapper";

    public static final String AUTHOR = "林智辉";
    public static final String PARENT_PACKAGE = "com.iyyxx.springmybatisplus";
